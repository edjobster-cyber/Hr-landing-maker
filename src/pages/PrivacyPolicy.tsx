...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "Privacy Policy | Edjobster";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Read Edjobster's Privacy Policy to learn how we collect, use, and protect your personal data."
      );
    }
  }, []);
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <ul>
                ...
                <li>
                  ...
                  Edjobster Pvt Ltd., 5170, 1st Floor, Phatak Hakim Mehmood Khan, Ballimaran, Chandni Chawk, Delhi-110006.
                </li>
                <li>
                ...
                <li>
                  <strong>Website</strong> refers to Edjobster, accessible from <a href="https://edjobster.com/">https://edjobster.com/</a>
                </li>
                <li>
              ...
              <p>
                ...
                <br />
                <em>Purpose:</em> These Cookies are essential to provide You with services available through the Website and to
              ...
              <p>
                ...
                <em>Administered by:</em> Us
                <br />
                <em>Purpose:</em> These Cookies identify if users have accepted the use of cookies on the Website.
              </p>
              ...
              <p>
                ...
                <em>Administered by:</em> Us
                <br />
                <em>Purpose:</em> These Cookies allow us to remember choices You make when You use the Website, such as remembering
              ...
              <ul>
                ...
                <li>
                  ...
                  or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our
              ...
              <ul>
                <li>
                  By email: <a href="mailto:edjobster@gmail.com">edjobster@gmail.com</a>
                </li>
              </ul>
            </div>
          </div>
