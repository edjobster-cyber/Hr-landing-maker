...
import { Share2, Network, Users, BarChart, CheckCircle, Calendar, ArrowRight } from "lucide-react";
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-lg text-gray-600 max-w-3xl mx-auto" data-testid="why-solution-description">
                                Tech hiring is fiercely competitive and skill-driven. Our AI platform helps you identify the right talent quickly and accurately.
                            </p>
                        </div>
                                ...
                                <div className="flex items-center flex-col relative w-full md:w-1/2">
                                    <div className="relative text-center mb-8 md:mb-16 w-full">
                                        ...
                                        <p className="relative mt-2 md:mt-4 text-lg md:text-2xl lg:text-3xl font-bold text-primary w-full md:w-[100%] lg:w-4/5 mx-auto">
                                            Overwhelming volume of applications, niche skill requirements, and lengthy technical screening.
                                        </p>
                                    </div>
                                    <img
                                        src={resume}
                                ...
                                <div className="flex items-center flex-col relative w-full md:w-1/2">
                                    <div className="relative text-center mb-8 md:mb-16 w-full">
                                        ...
                                        <p className="relative mt-2 md:mt-4 text-lg md:text-2xl lg:text-3xl font-bold text-[#FF7A32] w-full md:w-[100%] lg:w-4/5 mx-auto">
                                            AI creates skill-based screening questions, auto-generates technical assessments, and provides precise match scores aligned to job needs.
                                        </p>
                                    </div>
                                    <img
                                        src={airesume}
                            ...
                            <div className="sm:pl-[0px] md:pl-[23px] lg:pl-[100px]">
                                ...
                                <ul className="space-y-4 text-gray-600">
                                    <li className="flex items-start">
                                        ...
                                        Hard-to-source candidates for specialized roles
                                    </li>
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                                    ...
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                                        Inefficient technical assessments
                                    </li>
                                    <li className="flex items-start">
                                        <div className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                                        Slow feedback loops between hiring managers and recruiters
                                    </li>
                                </ul>
                            </div>
                            <div className="sm:pl-[0px] md:pl-[23px] lg:pl-[100px]">
                                ...
                                <ul className="space-y-4 text-gray-600">
                                    <li className="flex items-start">
                                        ...
                                        50% faster time-to-hire for engineering and product roles
                                    </li>
                                    <li className="flex items-start">
                                        <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" />
                                        Automated technical assessments with AI-curated questions
                                    </li>
                                    <li className="flex items-start">
                                        <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" />
                                        Improved candidate experience and higher offer acceptance rates
                                    </li>
                                    <li className="flex items-start">
                                        <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 mr-3 flex-shrink-0" />
                                        Centralized analytics for data-driven hiring decisions
                                    </li>
                                </ul>
                            </div>
                        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-brand shadow-brand">
                ...
                <div id="tech-contact" className="scroll-mt-24">
                    <ContactForm
                        platform="Technology"
                        title="Ready to Unify Your Multi-Campus Hiring?"
                        subTitle={`Join Technology organizations already using Edjobster to streamline hiring across all locations.`}
                    />
                </div>
            </main>
